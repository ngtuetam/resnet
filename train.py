...
if __name__ =="__main__":
    ...
    parser.add_argument('--train-folder', default='data/train', type=str, help='Path to train folder')
    parser.add_argument('--valid-folder', default='data/validation', type=str, help='Path to validation folder')
    ...
    # class_indices.keys(): trích xuất tên lớp từ tập dữ liệu trong từ điển
    ...
    if args.model == 'resnet18':
        ...
        print('Wrong resnet name, resnet name in [18, 34, 50, 101, 152]')
